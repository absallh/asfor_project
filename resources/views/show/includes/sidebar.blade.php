    ...
    <div class="scrollbar-inner">
        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('show/search')) ? 'active' : '' }}" href="{{ route('show') }}">
                    ...
                    <!-- Add Courses -->
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('show/subject*')) ? 'active' : '' }}" href="{{ route('subject.index') }}">
                    ...
                    <!-- Add Attendance -->
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('show/attendance*')) ? 'active' : '' }}" href="{{ route('attendance.index') }}">
                    ...
                    <!-- Add Attendance -->
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('show/setting*')) ? 'active' : '' }}" href="{{ route('settings.index') }}">
